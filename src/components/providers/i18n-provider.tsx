...
const dictionaries: I18nDictionaries = {
  en: {
    ...
    quizTitle: "MPU Practice Session (Beta)",
    quizSubtitle: "Personalized questions based on your case.",
    quizInstructions: "We will sync your profile and generate a question set. This practice tool supports learning and reflection.",
    quizStartPractice: "Start Practice",
    ...
    baselineTitle: "Personal Baseline (Required)",
    baselineSubtitle: "Answer a few questions to personalize your practice.",
    startBaseline: "Baseline",
    completeBaseline: "Complete Baseline",
    baselineSaved: "Your baseline has been saved.",
    baselineRequiredMsg: "Please complete your baseline intake to personalize and unlock your practice.",
    q_incident_summary: "What happened? Summarize the incident in your own words.",
    q_substance_and_frequency: "If substances were involved: which and how often before the incident?",
    q_bac_or_values: "Known BAC/THC or other values (if applicable)",
    q_abstinence_or_controlled_use: "Current abstinence or controlled use: since when, how do you ensure it?",
    q_therapy_or_support: "Therapy, counseling, or group support (what, where, how often)",
    q_behavior_change_steps: "What concrete steps have you taken to change your behavior?",
    q_risk_situations_and_strategies: "Typical risk situations and your strategies to handle them",
    q_support_network: "Who supports you (family, friends, colleagues, counselor)?",
    q_motivation_to_change: "Why do you want to change? What is different now?",
    q_goals_and_next_steps: "Your goals and next steps before the MPU",
    resetQuizData: "Reset Quiz Data",
    hint_incident_summary: "Keep it factual and concise. Include date, place, and what led to the situation.",
    hint_substance_and_frequency: "Describe substance type and frequency before the incident as realistically as possible.",
    hint_bac_or_values: "If known, provide values (e.g., 1.1‰ BAC, THC levels).",
    hint_abstinence_or_controlled_use: "Explain since when and how you ensure abstinence or controlled use.",
    hint_therapy_or_support: "Mention therapy, counseling, self-help groups and frequency.",
    hint_behavior_change_steps: "List concrete measures you have implemented (e.g., routines, rules).",
    hint_risk_situations_and_strategies: "Name typical triggers and how you avoid or cope with them.",
    hint_support_network: "Who can you call in critical moments and how do they help?",
    hint_motivation_to_change: "What has changed in your mindset and daily life since the incident?",
    hint_goals_and_next_steps: "What will you do next to stay on track until the MPU?",
    quizSessionDetails: "Quiz Session Details",
