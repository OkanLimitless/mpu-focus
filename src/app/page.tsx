...
export default function HomePage() {
  ...
  return (
    <div className={`${bodyFont.className} min-h-screen bg-slate-50 text-slate-900 selection:bg-emerald-100 selection:text-emerald-900`}>
      {/* Navigation */}
      <nav className="fixed top-0 z-50 w-full border-b border-slate-200 bg-white/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <Link href="/" className="flex items-center gap-2 group">
            <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-emerald-500 to-cyan-600 shadow-sm transition-transform group-hover:scale-105" />
            <span className={`${displayFont.className} text-xl font-bold tracking-tight text-slate-900 uppercase`}>MPU FOCUS</span>
          </Link>
        ...
        {/* Mobile Nav */}
        {mobileMenuOpen && (
          <div className="border-t border-slate-100 bg-white p-6 md:hidden animate-in slide-in-from-top-4 duration-200">
      ...
      <main className="pt-20">
        ...
        <section className="relative bg-white py-16 lg:py-24 overflow-hidden">
          <div className="absolute inset-0 z-0 opacity-[0.03] pointer-events-none">
            <div className="absolute top-0 left-0 h-full w-full bg-[radial-gradient(#10b981_1px,transparent_1px)] [background-size:24px_24px]" />
          </div>

          <div className="relative z-10 mx-auto max-w-7xl px-6">
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              <div className="max-w-xl animate-in fade-in slide-in-from-left-6 duration-700">
                <Badge variant="outline" className="mb-6 border-emerald-200 bg-emerald-50 py-1 text-emerald-700 font-semibold px-4 rounded-full">
                ...
                <h1 className={`${displayFont.className} text-5xl font-bold leading-[1.1] tracking-tight text-slate-900 md:text-7xl`}>
                  ...
                  <span className="text-emerald-600">sicher zurück.</span>
                </h1>
                ...
                <div className="mt-10 flex flex-wrap items-center gap-4">
                  <Button
                    size="lg"
                    className="h-14 rounded-2xl bg-emerald-600 px-8 text-lg font-bold shadow-lg shadow-emerald-600/20 hover:bg-emerald-700 transition-all hover:scale-105"
                    onClick={() => document.getElementById('kontakt')?.scrollIntoView({ behavior: 'smooth' })}
                  >
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className={`${displayFont.className} text-3xl font-bold md:text-5xl leading-tight`}>
                  ...
                  <span className="text-cyan-600">Ihren spezifischen Fall.</span>
                </h2>
                <div className="mt-10 space-y-8">
                  <div className="flex gap-5">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-slate-200 bg-slate-50 text-emerald-600">
                  ...
                  <div className="flex gap-5">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-slate-200 bg-slate-50 text-cyan-600">
                      <Check className="h-6 w-6" />
                    </div>
                    <div>
                  ...
                  <div className="flex gap-5">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-slate-200 bg-slate-50 text-purple-600">
                      <Check className="h-6 w-6" />
                    </div>
                    <div>
              ...
              <div className="relative">
                <div className="absolute -inset-4 rounded-[3rem] bg-gradient-to-tr from-emerald-100 to-cyan-100 blur-2xl opacity-50" />
                <div className="relative grid gap-4">
                  <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl animate-in fade-in slide-in-from-right-8 duration-700">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-full bg-emerald-500 p-2.5 text-white">
                  ...
                  <div className="ml-8 rounded-3xl border border-slate-200 bg-white p-6 shadow-xl animate-in fade-in slide-in-from-right-8 duration-700 delay-100">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-full bg-cyan-500 p-2.5 text-white">
                          <CheckCircle2 className="h-5 w-5" />
                        </div>
                  ...
                  <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl animate-in fade-in slide-in-from-right-8 duration-700 delay-200">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="h-10 w-10 rounded-full bg-purple-500 p-2.5 text-white">
                          <CheckCircle2 className="h-5 w-5" />
                        </div>
        ...
        {/* Process Section */}
        <section id="ablauf" className="bg-slate-900 py-24 text-white rounded-[4rem] mx-4 mb-24 overflow-hidden relative">
          <div className="absolute top-0 right-0 w-[40%] h-[40%] bg-emerald-500/10 blur-[100px]" />
          <div className="absolute bottom-0 left-0 w-[40%] h-[40%] bg-cyan-500/10 blur-[100px]" />
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-6 text-center">
            ...
            <div className="mt-20 grid gap-12 md:grid-cols-3 relative">
              ...
              <div className="relative z-10 flex flex-col items-center">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-500 text-white text-xl font-bold shadow-xl shadow-emerald-500/20 ring-8 ring-emerald-500/5">2</div>
                <h4 className="mt-8 text-xl font-bold">Gezielte Vorbereitung</h4>
                <p className="mt-3 text-emerald-50/70 text-sm leading-relaxed max-w-[240px]">Einzelberatungen, Aufarbeitung und strategische Gutachter-Simulation.</p>
              </div>

              <div className="relative z-10 flex flex-col items-center">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-cyan-500 text-white text-xl font-bold shadow-xl shadow-cyan-500/20 ring-8 ring-cyan-500/5">3</div>
                <h4 className="mt-8 text-xl font-bold">MPU bestehen</h4>
                <p className="mt-3 text-emerald-50/70 text-sm leading-relaxed max-w-[240px]">Mit Sicherheit und Selbstbewusstsein in das Gespräch gehen und den Führerschein zurückerhalten.</p>
              </div>
            </div>
          </div>
        </section>
              ...
              {[
                ...
                <div key={i} className="rounded-3xl border border-slate-100 bg-slate-50 p-6 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex gap-4">
                    <HelpCircle className="h-6 w-6 text-emerald-600 shrink-0" />
                    <div>
              ...
              <div className="grid gap-16 lg:grid-cols-2 relative z-10">
                <div>
                  <h2 className={`${displayFont.className} text-4xl font-bold md:text-5xl leading-tight`}>
                    ...
                    <span className="text-emerald-400 underline decoration-white/20 underline-offset-8">zurück zum Schein.</span>
                  </h2>
                  <p className="mt-8 text-xl text-emerald-50/80 leading-relaxed">
                ...
                <div className="rounded-[2.5rem] bg-white p-8 md:p-10 shadow-3xl text-slate-900">
                  <form className="space-y-4" onSubmit={onSubmit}>
                    ...
                    <Button
                      type="submit"
                      disabled={submitting}
                      className="h-14 w-full rounded-2xl bg-emerald-600 text-lg font-bold text-white shadow-lg shadow-emerald-600/20 hover:bg-emerald-700 hover:scale-[1.02] transition-all"
                    >
                    ...
                    {submitted && (
                      <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4 text-center animate-in fade-in zoom-in-95 duration-500">
                        <CheckCircle2 className="mx-auto h-8 w-8 text-emerald-600 mb-2" />
                        <p className="font-bold text-emerald-800">Vielen Dank!</p>
                        <p className="text-sm text-emerald-700">Wir haben Ihre Anfrage erhalten und melden uns in Kürze.</p>
                      </div>
                    )}
                    {error && (
          ...
          <div className="grid gap-12 md:grid-cols-4 items-start">
            <div className="col-span-1 md:col-span-2">
              <Link href="/" className="flex items-center gap-2 mb-6">
                <div className="h-7 w-7 rounded bg-gradient-to-br from-emerald-500 to-cyan-600" />
                <span className={`${displayFont.className} text-xl font-bold tracking-tight uppercase`}>MPU FOCUS</span>
              </Link>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-slate-600">
                <li><Link href="#vorteile" className="hover:text-emerald-600 transition-colors">Vorteile</Link></li>
                <li><Link href="#leistungen" className="hover:text-emerald-600 transition-colors">Leistungen</Link></li>
                <li><Link href="#ablauf" className="hover:text-emerald-600 transition-colors">Ablauf</Link></li>
                <li><Link href="/login" className="hover:text-emerald-600 transition-colors">Partner-Login</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-slate-600">
                <li><Link href="/impressum" className="hover:text-emerald-600 transition-colors">Impressum</Link></li>
                <li><Link href="/datenschutz" className="hover:text-emerald-600 transition-colors">Datenschutz</Link></li>
                <li><Link href="/agb" className="hover:text-emerald-600 transition-colors">AGB</Link></li>
              </ul>
            </div>
          </div>
